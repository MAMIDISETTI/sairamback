...
const createUser = async (req, res) => {
  try {
    const { 
      name, email, password, role, phone, department, employeeId, joiningDate,
      // Fields from joiners table
      date_of_joining, candidate_name, phone_number, candidate_personal_mail_id, Company_Maill_ID,
      joining_status, genre, role_type, role_assign, qualification, status, accountCreated, accountCreatedAt,
      Have_M_Tech_PC, Have_M_Tech_OD, Home_State, Year_of_Passout, Manager, Specialization,
    ...
    const userData = {
      ...
      Company_Maill_ID: Company_Maill_ID || null,
      joining_status: joining_status || null,
      genre: genre || null,
      role_type: role_type || null,
      role_assign: role_assign || null,
      qualification: qualification || null,
      Have_M_Tech_PC: Have_M_Tech_PC || null,
      Have_M_Tech_OD: Have_M_Tech_OD || null,
      Home_State: Home_State || null,
      Year_of_Passout: Year_of_Passout || null,
    ...
    res.status(201).json({
      ...
      user: {
        ...
        Company_Maill_ID: user.Company_Maill_ID,
        joining_status: user.joining_status,
        genre: user.genre,
        role_type: user.role_type,
        role_assign: user.role_assign,
        qualification: user.qualification,
        Have_M_Tech_PC: user.Have_M_Tech_PC,
        Have_M_Tech_OD: user.Have_M_Tech_OD,
